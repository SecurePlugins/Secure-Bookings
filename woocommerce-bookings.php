<?php
/**
 * Plugin Name: Secure Bookings
 * Requires Plugins: woocommerce
 * Plugin URI: https://github.com/SecurePlugins/Secure-Bookings
 * Description: Setting up bookable products enables businesses to manage reservations, services, and rentals effectively through their online platforms.
 * Version: 1.0.0
 * Author: SecurePlugins
 * Author URI: https://github.com/SecurePlugins/
...
if ( ! class_exists( 'WC_Bookings' ) ) :
	...
	define( 'WC_BOOKINGS_VERSION', '2.2.0' ); // WRCS: DEFINED_VERSION.
	...
	if ( ! defined( 'WC_BOOKINGS_CONNECT_WOOCOMMERCE_URL' ) ) {
		define( 'WC_BOOKINGS_CONNECT_WOOCOMMERCE_URL', 'https://api.woocommerce.com/integrations' );
	}

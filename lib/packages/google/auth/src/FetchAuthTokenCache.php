    ...
    UpdateMetadataInterface
{
    ...
    public function getClientName(callable $httpHandler = null)
    {
        if (!$this->fetcher instanceof SignBlobInterface) {
            throw new \RuntimeException(
                ...
                'Automattic\WooCommerce\Bookings\Vendor\Google\Auth\SignBlobInterface'
            );
        }
    ...
    public function getProjectId(callable $httpHandler = null)
    {
        if (!$this->fetcher instanceof ProjectIdProviderInterface) {
            throw new \RuntimeException(
                'Credentials fetcher does not implement ' .
                'Automattic\WooCommerce\Bookings\Vendor\Google\Auth\ProvidesProjectIdInterface'
            );
        }
    ...
    public function updateMetadata(
        ...
        if (!$this->fetcher instanceof UpdateMetadataInterface) {
            throw new \RuntimeException(
                'Credentials fetcher does not implement ' .
                'Automattic\WooCommerce\Bookings\Vendor\Google\Auth\UpdateMetadataInterface'
            );
        }

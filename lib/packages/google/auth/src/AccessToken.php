...
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Math\BigInteger as BigInteger3;
...
class AccessToken
{
    ...
    {
        return class_exists('Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\RSA');
    }

...
class OAuth2 implements FetchAuthTokenInterface
{
     ...
     * @throws \Automattic\WooCommerce\Bookings\Vendor\Firebase\JWT\SignatureInvalidException If the signature is invalid.
     * @throws \Automattic\WooCommerce\Bookings\Vendor\Firebase\JWT\BeforeValidException If the token is not yet valid.
     * @throws \Automattic\WooCommerce\Bookings\Vendor\Firebase\JWT\ExpiredException If the token has expired.
     * @return null|object
     */

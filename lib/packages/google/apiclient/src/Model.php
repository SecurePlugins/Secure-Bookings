...
{
    /**
     * If you need to specify a NULL JSON value, use Automattic\WooCommerce\Bookings\Vendor\Google\Model::NULL_VALUE
     ...
     * @throws \Automattic\WooCommerce\Bookings\Vendor\Google\Exception Thrown if $obj isn't an array.

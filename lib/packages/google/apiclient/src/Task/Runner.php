...
class Runner
{
     ...
     * @throws \Automattic\WooCommerce\Bookings\Vendor\Google\Task\Exception when misconfigured
     */
     ...
     *
     * @return mixed
     * @throws \Automattic\WooCommerce\Bookings\Vendor\Google\Service\Exception on failure when no retries are available.
     */
    public function run()
    {
        while ($this->attempt()) {

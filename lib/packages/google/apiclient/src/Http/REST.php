...
use Automattic\WooCommerce\Bookings\Vendor\Google\Task\Runner;
...
class REST
{
     ...
     * @return mixed|T|null
     * @throws \Automattic\WooCommerce\Bookings\Vendor\Google\Service\Exception on server side error (ie: not authenticated,
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (
                interface_exists('\Automattic\WooCommerce\Bookings\Vendor\GuzzleHttp\Message\ResponseInterface')
     ...
     * @param class-string<T>|false|null $expectedClass
     * @return mixed|T|null
     * @throws \Automattic\WooCommerce\Bookings\Vendor\Google\Service\Exception
     */

 ...
 *
 *    $ssh = new \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\PublicKeyLoader::load('...', '(optional) password');
 *
 *    $ssh = new \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Net\SSH2('www.domain.tld');
...
namespace Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Net;

use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Common\Functions\Strings;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Blowfish;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\ChaCha20;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\AsymmetricKey;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\PrivateKey;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\PublicKey;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\DH;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\DSA;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Hash;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Random;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\RC4;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Rijndael;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\RSA;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\TripleDES; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Twofish;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\ConnectionClosedException;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\InsufficientSetupException;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\NoSupportedAlgorithmsException;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\UnableToConnectException;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\UnsupportedAlgorithmException;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\UnsupportedCurveException;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Math\BigInteger;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\System\SSH\Agent;
...
class SSH2
{
     ...
     *     the other side.
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Net\SSH2::send_channel_packet()
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Net\SSH2::get_channel_packet()
     */
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Net\SSH2::getLog()
     */
    const LOG_SIMPLE = 1;
    /**
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Net\SSH2::read()
     */
    const READ_SIMPLE = 1;
    /**
     ...
     * @throws \UnexpectedValueException on receipt of unexpected packets
     * @throws \RuntimeException on other errors
     * @throws \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\NoSupportedAlgorithmsException when none of the algorithms phpseclib has loaded are compatible
     */
     ...
     *
     * @param string $username
     * @param \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\System\SSH\Agent $agent
     * @return bool
     */
     ...
     *
     * @param string $username
     * @param \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\PrivateKey $privatekey
     * @return bool
     * @throws \RuntimeException on connection error
     */
     ...
     * @throws \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\NoSupportedAlgorithmsException when the key isn't in a supported format
     */

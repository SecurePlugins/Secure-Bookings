 ...
 *
 *    $sftp = new \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Net\SFTP('www.domain.tld');
...
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\FileNotFoundException;
...
class SFTP extends SSH2
{
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Net\SFTP::put()
     */
     ...
     *
     * By default, \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Net\SFTP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     ...
     * @throws \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\FileNotFoundException if you're uploading via a file and the file doesn't exist
     * @return bool
     */

 ...
 * <code>
 * <?php
 *    $a = new \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Math\BigInteger(2);
 *    $b = new \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Math\BigInteger(3);
 *
 *    $c = $a->add($b);
 *
...
namespace Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Math;

use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\BadConfigurationException;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Math\BigInteger\Engines\Engine;
...
class BigInteger implements \JsonSerializable
{
    ...
    public static function setEngine($main, array $modexps = ['DefaultEngine'])
    {
        ...
        $fqmain = 'Automattic\\WooCommerce\\Bookings\\Vendor\\phpseclib3\\Math\\BigInteger\\Engines\\' . $main;
     ...
     * <code>
     * <?php
     *    $a = new \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Math\BigInteger('10');
     *    $b = new \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Math\BigInteger('20');
     *

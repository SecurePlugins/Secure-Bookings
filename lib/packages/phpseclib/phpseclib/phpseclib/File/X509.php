...
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\RSA\Formats\Keys\PSS;
...
class X509
{
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\File\X509::getDN()
     */
    const DN_ARRAY = 0;
    /**
     * Return string
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\File\X509::saveX509()
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\File\X509::saveCSR()
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\File\X509::saveCRL()
     */
    const FORMAT_PEM = 0;
    /**
     * Save as DER
     ...
     * Default Constructor.
     *
     * @return \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\File\X509
     */
    ...
    public function saveX509(array $cert, $format = self::FORMAT_PEM)
    {
        ...
        /* in the case of policyQualifiers/qualifier, the type has to be \phpseclib3\File\ASN1::TYPE_IA5_STRING.
           \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\File\ASN1::TYPE_PRINTABLE_STRING will cause OpenSSL's X.509 parser to spit out random
           characters.
         */
     ...
     * @throws \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\UnsupportedAlgorithmException if the algorithm is unsupported
     * @return bool
     */
    ...
    public function sign(X509 $issuer, X509 $subject)
    {
        ...
        if (isset($subject->domains) && count($subject->domains)) {
            $altName = array_map(['\Automattic\WooCommerce\Bookings\Vendor\phpseclib3\File\X509', 'dnsName'], $subject->domains);
        }
    ...
    public function computeKeyIdentifier($key = null, $method = 1)
    {
        ...
        switch (true) {
            ...
            case $key instanceof X509:
                ...
                return false;
            default: // Should be a key object (i.e.: \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\RSA).

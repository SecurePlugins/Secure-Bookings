 ...
 *
 *    $des = new \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\DES('ctr');
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\BlockCipher;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\BadModeException;
...
class DES extends BlockCipher
{
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\DES::setupKey()
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\DES::processBlock()
     */
    const ENCRYPT = 0;
    /**
     ...
     * Key Length (in bytes)
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::setKeyLength()
     * @var int
     */
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::cipher_name_mcrypt
     * @var string
     */
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::openssl_mode_names
     * @var array
     */
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::cfb_init_len
     * @var int
     */
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::isValidEngine()
     * @param int $engine
     * @return bool
     */
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::setKey()
     * @param string $key
     */
     ...
     * Encrypts a block
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::encryptBlock()
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::encrypt()
     * @see self::encrypt()
     * @param string $in
     * @return string
     */
     ...
     * Decrypts a block
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::decryptBlock()
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::decrypt()
     * @see self::decrypt()
     * @param string $in
     * @return string
     */
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::setupKey()
     */
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::setupInlineCrypt()
     */

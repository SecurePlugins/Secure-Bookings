...
namespace Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\Formats\Keys;

use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Common\Functions\Strings;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\Formats\Keys\JWK as Progenitor;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\BaseCurves\Base as BaseCurve;
...
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\Curves\secp256k1;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\Curves\secp256r1;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\Curves\secp384r1;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\Curves\secp521r1;
...
abstract class JWK extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $curve = '\Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\Curves\\' . str_replace('P-', 'nistp', $key->crv);
        $curve = new $curve();
     ...
     *
     * @param \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\BaseCurves\Base $curve
     * @param \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Math\Common\FiniteField\Integer[] $publicKey
     * @return array
     */
     ...
     *
     * @param \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Math\BigInteger $privateKey
     * @param \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\Curves\Ed25519 $curve
     * @param \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Math\Common\FiniteField\Integer[] $publicKey

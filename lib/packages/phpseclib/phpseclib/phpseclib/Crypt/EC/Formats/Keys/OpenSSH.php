...
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\Formats\Keys\OpenSSH as Progenitor;
...
abstract class OpenSSH extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if ($parsed['type'] == 'ssh-ed25519') {
            ...
            $curveName = '\Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\Curves\\' . $curveName;
            $curve = new $curveName();

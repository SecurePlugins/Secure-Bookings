...
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\BaseCurves\Prime as PrimeCurve;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\BadConfigurationException;
...
abstract class XML
{
     ...
     *
     * @param \DomXPath $xpath
     * @return \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\BaseCurves\Base|false
     */
    private static function loadCurveByParam(\DOMXPath $xpath)
    {
        ...
        if ($namedCurve->length == 1) {
            ...
            $curve = '\Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\Curves\\' . $name;

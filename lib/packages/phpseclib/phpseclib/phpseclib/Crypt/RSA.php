 ...
 *
 * $private = \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\RSA::createKey();
...
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\RSA\PrivateKey;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\RSA\PublicKey;
...
abstract class RSA extends AsymmetricKey
{
     ...
     *
     * @var \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Hash
     */
    protected $mgfHash;
     ...
     *
     * @param bool|\Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Math\BigInteger $x
     * @param int $xLen
     * @return bool|string
     */

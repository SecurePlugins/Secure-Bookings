 ...
 *
 *    $rc2 = new \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\RC2('ctr');
 *
 *    $rc2->setKey('abcdefgh');
 *
...
class RC2 extends BlockCipher
{
     ...
     * The Key
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::key
     * @see self::setKey()
     * @var string
     */
    protected $key;
     ...
     * Key Length (in bytes)
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\RC2::setKeyLength()
     * @var int
     */

 ...
 *
 *    $des = new \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\TripleDES('ctr');
 *
...
class TripleDES extends DES
{
     ...
     * Key Length (in bytes)
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\TripleDES::setKeyLength()
     * @var int
     */
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\DES::cipher_name_mcrypt
     ...
     *
     * @see self::setKey()
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\DES::setKey()
     * @var string
     */
     ...
     * - cbc3 (same as cbc)
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\DES::__construct()
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::setIV()
     * @param string $iv
     */
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::enableContinuousBuffer()
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::disableContinuousBuffer()
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::__construct()
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::setPreferredEngine()
     * @param int $engine
     */

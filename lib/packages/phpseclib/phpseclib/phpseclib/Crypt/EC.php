 ...
 *
 * $private = \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC::createKey('secp256k1');
...
namespace Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt;

use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\AsymmetricKey;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\Curves\Curve25519;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\Curves\Ed25519;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\Curves\Ed448;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\Formats\Keys\PKCS1;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\Parameters;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\PrivateKey;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\PublicKey;
...
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\UnsupportedOperationException;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\File\ASN1;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\File\ASN1\Maps\ECParameters;
...
abstract class EC extends AsymmetricKey
{
     ...
     * Curve
     *
     * @var \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\BaseCurves\Base
     */
    protected $curve;
     ...
     *
     * @param string $curve
     * @return \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\PrivateKey
     */
    public static function createKey($curve)
    {
        ...
        $curve = '\Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\EC\Curves\\' . $curveName;

...
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\BadDecryptionException;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\BadModeException;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Exception\InconsistentSetupException;
...
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Math\BinaryField;
use Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Math\PrimeField;
...
abstract class SymmetricKey
{
     ...
     * Engine Reverse Map
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Common\SymmetricKey::getEngine()
     */
    const ENGINE_MAP = [
     ...
     *
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Twofish::setKey()
     * @see \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Twofish::setIV()
     * @var bool
     */
     ...
     * @see self::setPassword()
     * @param int $n
     * @param \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Crypt\Hash $hashObj
     * @param string $i
     * @param string $d
     * @param int $count
     * @return string $a
                    ...
                    if (strlen($_buffer["ciphertext"])) {
                        for ($_i = 0; $_i < $_plaintext_len; $_i+= ' . $block_size . ') {
                            ...
                            if (strlen($_block) > strlen($_buffer["ciphertext"])) {
                                $in = $_xor;
                                ' . $encrypt_block . '
                                \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Common\Functions\Strings::increment_str($_xor);
                                $_buffer["ciphertext"].= $in;
                            }
                            $_key = \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Common\Functions\Strings::shift($_buffer["ciphertext"], ' . $block_size . ');
                ...
                $encrypt = $init_encrypt . '
                    ...
                    if (strlen($_buffer["xor"])) {
                        for ($_i = 0; $_i < $_plaintext_len; $_i+= ' . $block_size . ') {
                            ...
                            $_key = \Automattic\WooCommerce\Bookings\Vendor\phpseclib3\Common\Functions\Strings::shift($_buffer["xor"], ' . $block_size . ');
                            $_ciphertext.= $_block ^ $_key;
                        }
                    } else {
                        for ($_i = 0; $_i < $_plaintext_len; $_i+= ' . $block_size . ') {

...
namespace Automattic\WooCommerce\Bookings\Vendor\Monolog\Formatter;

use Automattic\WooCommerce\Bookings\Vendor\Monolog\DateTimeImmutable;
...
class NormalizerFormatter implements FormatterInterface
{
    ...
    public function __construct(?string $dateFormat = null)
    {
        ...
        if (!function_exists('json_encode')) {
            throw new \RuntimeException('PHP\'s json extension is required to use Automattic\WooCommerce\Bookings\Vendor\Monolog\'s NormalizerFormatter');
        }
    }

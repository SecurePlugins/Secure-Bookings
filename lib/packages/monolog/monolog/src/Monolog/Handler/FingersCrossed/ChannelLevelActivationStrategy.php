...
namespace Automattic\WooCommerce\Bookings\Vendor\Monolog\Handler\FingersCrossed;
...
class ChannelLevelActivationStrategy implements ActivationStrategyInterface
{
    ...
    public function __construct($defaultActionLevel, array $channelToActionLevel = [])
    {
        ...
        $this->channelToActionLevel = array_map('Automattic\WooCommerce\Bookings\Vendor\Monolog\Logger::toMonologLevel', $channelToActionLevel);
    }

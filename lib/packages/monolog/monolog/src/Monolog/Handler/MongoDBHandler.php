...
use Automattic\WooCommerce\Bookings\Vendor\Monolog\Formatter\MongoDBFormatter;
 ...
 * Usage example:
 *
 *   $log = new \Automattic\WooCommerce\Bookings\Vendor\Monolog\Logger('application');
 *   $client = new \MongoDB\Client('mongodb://localhost:27017');
 *   $mongodb = new \Automattic\WooCommerce\Bookings\Vendor\Monolog\Handler\MongoDBHandler($client, 'logs', 'prod');

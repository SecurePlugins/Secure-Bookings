...
use Automattic\WooCommerce\Bookings\Vendor\Monolog\Formatter\LineFormatter;
 ...
 *
 *      $logger = new \Automattic\WooCommerce\Bookings\Vendor\Monolog\Logger('all', array(new \Automattic\WooCommerce\Bookings\Vendor\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['Automattic\\WooCommerce\\Bookings\\Vendor\\Monolog\\'], // array Hide calls of classes started with...
